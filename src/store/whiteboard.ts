...
export const DEFAULT_GOALS_ID      = '00000000-0000-4000-8000-000000000010'
...
export function ensureSystemBoards(boards: Board[]): Board[] {
  ...
  if (!result.some((b) => b.boardType === 'goals')) {
    result = [...result, { id: DEFAULT_GOALS_ID, name: 'Goals', layoutId: DEFAULT_LAYOUT_ID, boardType: 'goals', widgets: [] }]
  }
  return result
}
