...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    emoji: '✦',
    dark: false,
    previewColors: ['#f9f5ff', '#e9d5ff', '#7c3aed', '#3b0764'],
    background: { label: 'Lavender', bg: '#f5f0ff', dot: '#ddd6fe' },
    vars: {
      widgetBg:           '#f9f5ff',
      widgetBorder:       '#e9d5ff',
      widgetBorderActive: '#d8b4fe',
      shadowSm:           '0 1px 3px rgba(124,58,237,0.07)',
      shadowMd:           '0 4px 12px rgba(124,58,237,0.1)',
      shadowLg:           '0 20px 40px rgba(124,58,237,0.14)',
      backdropFilter:     'none',
      textPrimary:        '#3b0764',
      textMuted:          '#a78bfa',
      surfaceSubtle:      '#faf5ff',
      surfaceHover:       '#ede9fe',
      surfaceDanger:      '#fef2f2',
      accent:             '#7c3aed',
      accentText:         '#ffffff',
      ...
      actionBorder:       '#e9d5ff',
      settingsBg:         '#f9f5ff',
      settingsBorder:     '#e9d5ff',
      settingsDivider:    '#ede9fe',
      settingsLabel:      '#c4b5fd',
      scrollThumb:        '#c4b5fd',
      clockFaceFill:      '#f9f5ff',
      clockFaceStroke:    '#e9d5ff',
      clockTickMajor:     '#a78bfa',
      clockTickMinor:     '#e9d5ff',
      clockHands:         '#3b0764',
      clockSecond:        '#7c3aed',
      clockCenter:        '#3b0764',
      noteDefaultBg:      '#ede9fe',
    },
  },
  {
    id: 'ocean',
